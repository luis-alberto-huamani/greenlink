...
/* harmony import */ var _card_post_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("J1yF");
...
function (_Component) {
  ...
  function CardPost(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, CardPost);
    ...
    _this.onPopConfig = _this.onPopConfig.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(CardPost, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.setState({
...
// EXTERNAL MODULE: ./components/perfil.scss
var perfil = __webpack_require__("SRLO");

// EXTERNAL MODULE: ./components/perfil-header.scss
var perfil_header = __webpack_require__("SIoK");

// CONCATENATED MODULE: ./components/perfil-header.jsx
...
/* harmony default export */ var components_perfil_header = (perfil_header_PerfilHeader);
// EXTERNAL MODULE: ./components/perfil-nav.jsx + 1 modules
var perfil_nav = __webpack_require__("3kSw");

// CONCATENATED MODULE: ./components/perfil.jsx
...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(Login, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement(components_perfil_header, {
        user: user
      }), external_react_default.a.createElement(perfil_nav["a" /* default */], {
        user: user,
        id: id,
        posts: user.posts
      })));
...
/* harmony default export */ var components_perfil = (Object(external_react_redux_["connect"])(mapStateToProps, perfil_mapDispatchToProps)(perfil_Login));
// EXTERNAL MODULE: ./node_modules/next/link.js
var next_link = __webpack_require__("YFqc");
...
var perfil_App = function App(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("meta", {
    name: "viewport",
    content: "width=device-width, initial-scale=1"
  }), external_react_default.a.createElement("meta", {
    charSet: "utf-8"
  })), external_react_default.a.createElement(layout["a" /* default */], null, external_react_default.a.createElement(components_perfil, {
    user: props.user,
    id: props.id
  })));
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return external_isomorphic_unfetch_default()("http://localhost:3000/api/perfil", {
              headers: {
                "Content-Type": "application/json"
              },
              method: "POST",
